...
class BusinessLinkController extends Controller
{
    ...
    {
        return view('admin.businesses.businesses-links-create');
    }
    ...
    public function edit(Business $business){
        return view('admin.businesses.businesses-links-edit', compact('business'));
    }
    ...
    public function store(Request $request, Business $business)
    {
        ...
        if ($request->isMethod('post')){
            ...
            return redirect()->route('admin.businesses.media.create', $business->id);
        }else{
            // put method
