...
class BusinessRestaurantTypeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.businesses.businesses-restaurant-type-create', compact('restaurant_types', 'food_types'));
    }
    ...
    public function edit(Business $business){
        ...
        return view('admin.businesses.businesses-restaurant-type-edit', compact('restaurant_types', 'food_types','business'));
    }
