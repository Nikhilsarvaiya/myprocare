...
class BusinessMediaController extends Controller
{
    ...
    {
        return view('admin.businesses.businesses-media-create');
    }
    ...
    public function store(Request $request, Business $business)
    {
        ...
        if ($business->businessType->sell_food_beverage === 1){
            return redirect()->route('admin.businesses.restaurant_type.create', $business->id);
        }
    ...
    public function edit($businessId)
    {
        ...
        return view('admin.businesses.businesses-media-edit', compact('business'));
    }
