...
class BusinessOpeningHourController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.businesses.businesses-opening-hours-create', compact('days'));
    }
    ...
    public function edit(Business $business)
    {
        ...
        return view('user.businesses.businesses-opening-hours-edit', compact('days', 'business'));
    }
    ...
    public function store(Request $request, Business $business)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('user.businesses.links.create', $business->id);
        } else {
            // put method
