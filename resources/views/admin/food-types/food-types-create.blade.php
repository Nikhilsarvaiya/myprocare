...
@section('main')
    ...
    <div class="flex justify-between">
        <h1 class="mb-3 text-xl font-semibold dark:text-white">Food Type Create</h1>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.food-types.store') }}">
        @csrf
