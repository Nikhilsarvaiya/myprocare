...
@section('main')
    ...
    <div class="lg:flex lg:justify-between items-center">
        <!-- Search Bar -->
        <x-web.table-search-bar :url="route('admin.road-closures.index')"/>

        <div class="mb-3 flex items-center space-x-3">
            <a href="{{ route('admin.road-closures.index') }}">
                <x-secondary-button>
            ...
            <a href="{{ route('admin.road-closures.create') }}">
    ...
    <x-table.main :columns="$columns">
        @foreach($road_closures as $road_closure)
            <x-table.tr>
                ...
                <x-table.td>
                    <a href="{{ route('admin.road-closures.edit', $road_closure->id) }}" class="mr-2 text-blue-500 hover:underline">Edit</a>
                    <form action="{{ route('admin.road-closures.destroy',$road_closure->id) }}" method="Post"
