...
@section('main')
    ...
    <div class="flex justify-between">
        ...
        <a href="{{ route('admin.businesses.links.edit', request()->route('business')) }}">
            <x-secondary-button>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.businesses.media.update', request()->route('business')) }}">
        @csrf
        @method('PUT')
