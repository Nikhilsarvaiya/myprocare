...
@section('main')
    ...
    <div class="flex justify-between">
        ...
        <a href="{{ route('admin.businesses.restaurant_type.edit', request()->route('business')) }}">
            <x-secondary-button>
            ...
            <x-table.main :columns="$columns">
                @foreach($menuItems as $menuItem)
                    <x-table.tr>
                        ...
                        <x-table.td>
                            <a href="{{ route('admin.businesses.menus.edit', ['business' => request()->route('business'), 'menu' => $menuItem->id, 'redirect' => 'edit']) }}" class="mr-2 text-blue-500 hover:underline">Edit</a>
                            <form
                                action="{{ route('admin.businesses.menus.destroy',['business' => request()->route('business'), 'menu' => $menuItem->id]) }}"
                                method="Post"
