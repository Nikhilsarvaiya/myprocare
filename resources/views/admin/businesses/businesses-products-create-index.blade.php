...
@section('main')
    ...
    <div class="flex justify-between">
        <h1 class="mb-3 text-xl font-semibold dark:text-white">Create Product</h1>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.businesses.products.store', request()->route('business')) }}">
        @csrf
        ...
        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            @foreach($products as $product)
                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.businesses.products.edit', ['business' => request()->route('business'), 'product' => $product->id, 'redirect' => 'create']) }}" class="mr-2 text-blue-500 hover:underline">Edit</a>
                        <form action="{{ route('admin.businesses.products.destroy',['business' => request()->route('business'), 'product' => $product->id]) }}" method="Post"
