...
@section('main')
    ...
    <form
        method="POST"
        action="{{ request()->routeIs('user.businesses.basic_details.create') ? route('user.businesses.basic_details.store') : route('user.businesses.basic_details.update', request()->route('business')) }}"
        x-data="{
