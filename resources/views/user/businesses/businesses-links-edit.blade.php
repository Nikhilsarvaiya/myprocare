...
@section('main')
    ...
    <div class="flex justify-between">
        <h1 class="mb-3 text-xl font-semibold dark:text-white">Edit Business Links</h1>

        <a href="{{ route('user.businesses.opening_hours.edit', request()->route('business')) }}">
            <x-secondary-button>
    ...
    <form method="POST" action="{{ route('user.businesses.links.store', request()->route('business')) }}">
        @csrf
        @method('PUT')
