        ...
        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            @foreach($products as $product)
                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('user.businesses.products.edit', ['business' => request()->route('business'), 'product' => $product->id, 'redirect' => 'create']) }}" class="mr-2 text-blue-500 hover:underline">Edit</a>
                        <form action="{{ route('user.businesses.products.destroy',['business' => request()->route('business'), 'product' => $product->id]) }}" method="Post"
