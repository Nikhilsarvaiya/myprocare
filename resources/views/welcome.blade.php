...
@section('main')
    ...
    <section class="max-w-screen-xl mx-auto">
        <div class="px-4 pb-8 lg:py-16 grid lg:grid-cols-12 lg:gap-8 xl:gap-0">
            <div class="lg:hidden lg:mt-0 lg:col-span-5 lg:flex">
    ...
    <footer>
        <div class="max-w-screen-xl p-4 pb-6 mx-auto lg:pb-10 md:p-8 lg:p-10">
